...
#ifndef BTNPIN
#define BTNPIN  0  //D3 - button pin. Needs to have pullup (gpio0 recommended)
#endif
...
#ifndef RLYPIN
#define RLYPIN 12  //D6 - pin for relay, will be set HIGH if LEDs are on (-1 to disable). Also usable for standby leds, triggers,...
#endif
